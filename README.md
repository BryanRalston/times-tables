...
3. Drag the dots you can see off the frame. Tapping leftover cells or the n box bounces toward those dots — it does not sit mute and does not cover the model with a lecture. The heading stays `6 + n = 10`. Type the leftover in the n-box. A wrong leftover tilts; the board stays.
