...
describe("CandyPath", () => {
  ...
  it("maps all 13 Grade 3 units on one tall map and locks later nodes", () => {
    ...
    expect(html).toContain('data-candy-prop="daisies-b"');
    expect(html).toContain('data-candy-prop="gumdrop"');
    expect(html).toContain('data-candy-prop="lollipop"');
    ...
    expect(html).toContain('data-candy-prop="peppermint"');
    expect(html).toContain('data-candy-prop="shell"');
    expect(html).toContain('data-candy-prop="fraction-pie"');
    expect(html).toContain('data-candy-prop="pie-tart"');
    expect(html).toContain('data-candy-prop="numbered-sweet"');
    ...
    expect(html).toContain("candy-zones/overlays/lollipop.png");
    expect(html).toContain("candy-zones/overlays/peppermint.png");
    expect(html).toContain("candy-zones/overlays/shell.png");
    expect(html).toContain("candy-zones/overlays/pie-tart.png");
    expect(html).toContain("candy-zones/overlays/numbered-sweet.png");
