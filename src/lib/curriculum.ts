...
export const UNITS: UnitDef[] = [
  {
    ...
    activities: [
      A("u1-leftover", "What's hiding", "Ten-frames. Tap the dots you can see, then name what's hiding.", ["3.NS.1"], "tenframe", { maxTotal: 10, mode: "add" }),
  ...
  },
  {
    ...
    activities: [
      ...
      A("u2-expanded", "Tens you can see", "60 + ? = 64. Leftover ones on a tens-and-ones board.", ["3.NS.1.c", "3.CE.1"], "placevalue", { mode: "expanded" }),
  ...
  },
  {
    ...
    activities: [
      ...
      A("u3-factor", "Missing factor", "2 × ? = 8. Isolate one group, then name what's hiding.", ["3.CE.2.a"], "groups", { hide: "groups", factors: [2, 3, 4, 5] }),
  ...
  },
  {
    ...
    activities: [
      ...
      A("u6-factor", "Missing factor", "5 × ? = 30. Isolate one group.", ["3.CE.2.d"], "groups", { hide: "groups", factors: [2, 5, 10] }),
  ...
  },
  {
    ...
    activities: [
      ...
      A("u9-factor", "Missing factor", "4 × ? = 32. Isolate one group.", ["3.CE.2.d"], "groups", { hide: "groups", factors: [3, 4, 8, 9] }),
...
export const WELCOME_ACTIVITY: ActivityDef = {
  id: "welcome",
  title: "What's hiding",
  blurb: "Tap the dots you can see. Then name what's hiding.",
  sol: ["3.NS.1"],
  kind: "tenframe",
  rounds: 4,
