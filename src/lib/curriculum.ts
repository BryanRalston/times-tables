...
export const UNITS: UnitDef[] = [
  {
    ...
    activities: [
      A("u1-leftover", "What's hiding", "Ten-frames. Tap the dots you can see, then name n.", ["3.NS.1"], "tenframe", { maxTotal: 10, mode: "add" }),
...
export const WELCOME_ACTIVITY: ActivityDef = {
  id: "welcome",
  title: "What's hiding",
  blurb: "Tap the dots you can see. Then name n.",
  sol: ["3.NS.1"],
  kind: "tenframe",
  rounds: 4,
