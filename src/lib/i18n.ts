...
export const UI: Record<Locale, Ui> = {
  ...
  es: {
    ...
    resetBlurb: "Reiniciar borra estrellas, racha y la visita del resto. Nada sale del aparato.",
    grownupBlurb:
  ...
  "pt-BR": {
    ...
    resetBlurb: "Reiniciar apaga estrelas, sequência e a visita do resto. Nada sai do aparelho.",
    grownupBlurb:
