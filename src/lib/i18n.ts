...
export type Ui = {
  ...
  nIs: (n: string) => string;
  itsClock: (t: string) => string;
  thats: (n: string) => string;
  countCoins: string;
  countMoney: string;
  takeCoins: string;
  bankTap: string;
...
export const UI: Record<Locale, Ui> = {
  en: {
    ...
    tapAGroup: "Tap a group to isolate it, then name what's hiding.",
    ...
    leftoverBlurb: "6 + ? = 10 on a ten-frame. Then Home and every lesson.",
  ...
  es: {
    ...
    tapAGroup: "Toca un grupo para aislarlo, luego nombra lo que se esconde.",
    ...
    leftoverBlurb: "6 + ? = 10 en un marco de diez. Luego Inicio y cada lección.",
    ...
    nOnesHiding: "unidades que se esconden",
  },
  "pt-BR": {
    language: "Idioma",
    home: "Início",
    ...
    tapAGroup: "Toque um grupo para isolá-lo, depois nomeie o que está escondido.",
    ...
    leftoverBlurb: "6 + ? = 10 num quadro de dez. Depois Início e cada lição.",
    ...
    nOnesHiding: "unidades escondidas",
  },
};
...
> = {
  en: {
    ...
    convert: (n, from, to) => `${n} ${from} = ? ${to}. How many?`,
  ...
  es: {
    ...
    convert: (n, from, to) => `${n} ${from} = ? ${to}. ¿Cuántos?`,
  ...
  "pt-BR": {
    ...
    convert: (n, from, to) => `${n} ${from} = ? ${to}. Quantos?`,
...
function measureEn(): QCopy["measureUnits"] {
  return [
    ...
    { prompt: "Best unit for the weight of a watermelon?", answer: "pound", choices: ["ounce", "pound", "inch", "cup"] },
    ...
    { prompt: "Best unit for the liquid in a bottle of milk?", answer: "liter", choices: ["liter", "milliliter", "inch", "ton"] },
    { prompt: "Best unit for the length of a paper clip?", answer: "centimeter", choices: ["centimeter", "kilometer", "gallon", "ton"] },
    { prompt: "Best unit for a kid's height?", answer: "centimeter", choices: ["mile", "centimeter", "gallon", "ton"] },
    { prompt: "Best unit for the mass of a bag of apples?", answer: "kilogram", choices: ["milliliter", "kilogram", "inch", "second"] },
...
export function qCopy(locale: Locale): QCopy {
  if (locale === "es") {
    return {
      leftoverHint: "Toca los puntos que ves. Luego nombra lo que se esconde.",
      leftoverPieces: (shown, den) => `${shown}/${den} + ? = 1. ¿Qué fracción se esconde?`,
      leftoverPiecesHint: "Toca las piezas que ves.",
      tensHint: "Decenas que ves. Las unidades que faltan se esconden.",
      ...
      buildHundreds: (target) => `Este es ${target}. ¿Cuántos bloques de centenas?`,
      ...
      combineTT: "Dos triángulos comparten un lado. Cuenta los lados de afuera. ¿Qué polígono?",
      combineTQ: "Un triángulo y un cuadrilátero comparten un lado. Cuenta los lados de afuera. ¿Qué polígono?",
      combineQQ: "Dos cuadriláteros comparten un lado. Cuenta los lados de afuera. ¿Qué polígono?",
      combineTP: "Un triángulo y un pentágono comparten un lado. Cuenta los lados de afuera. ¿Qué polígono?",
      ...
      equivN: (num, den, den2) => `${num}/${den} = ?/${den2}. ¿Cuántos?`,
      ...
      squaresHide: (shown) => `${shown} cuadrados se ven. Algunos se esconden. ¿Área?`,
      ...
      wordTakeHint: "Toca los que ves. Luego nombra lo que se esconde.",
      ...
      measureUnits: [
        ...
        { prompt: "¿Mejor unidad para el peso de una sandía?", answer: "pound", choices: ["ounce", "pound", "inch", "cup"] },
        ...
        { prompt: "¿Mejor unidad para el líquido de una botella de leche?", answer: "liter", choices: ["liter", "milliliter", "inch", "ton"] },
        { prompt: "¿Mejor unidad para el largo de un clip?", answer: "centimeter", choices: ["centimeter", "kilometer", "gallon", "ton"] },
        { prompt: "¿Mejor unidad para la estatura de un niño?", answer: "centimeter", choices: ["mile", "centimeter", "gallon", "ton"] },
        { prompt: "¿Mejor unidad para la masa de una bolsa de manzanas?", answer: "kilogram", choices: ["milliliter", "kilogram", "inch", "second"] },
  ...
  if (locale === "pt-BR") {
    return {
      leftoverHint: "Toque os pontos que você vê. Depois nomeie o que está escondido.",
      leftoverPieces: (shown, den) => `${shown}/${den} + ? = 1. Que fração está escondida?`,
      leftoverPiecesHint: "Toque as peças que você vê.",
      tensHint: "Dezenas que você vê. As unidades que faltam se escondem.",
      ...
      buildHundreds: (target) => `Este é ${target}. Quantos blocos de centenas?`,
      ...
      combineTT: "Dois triângulos compartilham um lado. Conte os lados de fora. Qual polígono?",
      combineTQ: "Um triângulo e um quadrilátero compartilham um lado. Conte os lados de fora. Qual polígono?",
      combineQQ: "Dois quadriláteros compartilham um lado. Conte os lados de fora. Qual polígono?",
      combineTP: "Um triângulo e um pentágono compartilham um lado. Conte os lados de fora. Qual polígono?",
      ...
      equivN: (num, den, den2) => `${num}/${den} = ?/${den2}. Quantos?`,
      ...
      squaresHide: (shown) => `${shown} quadrados aparecem. Alguns se escondem. Área?`,
      ...
      wordTakeHint: "Toque os que você vê. Depois nomeie o que está escondido.",
      ...
      measureUnits: [
        ...
        { prompt: "Melhor unidade para o peso de uma melancia?", answer: "pound", choices: ["ounce", "pound", "inch", "cup"] },
        ...
        { prompt: "Melhor unidade para o líquido de uma garrafa de leite?", answer: "liter", choices: ["liter", "milliliter", "inch", "ton"] },
        { prompt: "Melhor unidade para o comprimento de um clipe?", answer: "centimeter", choices: ["centimeter", "kilometer", "gallon", "ton"] },
        { prompt: "Melhor unidade para a altura de uma criança?", answer: "centimeter", choices: ["mile", "centimeter", "gallon", "ton"] },
        { prompt: "Melhor unidade para a massa de um saco de maçãs?", answer: "kilogram", choices: ["milliliter", "kilogram", "inch", "second"] },
  ...
  return {
    leftoverHint: "Tap the dots you can see. Then name what's hiding.",
    leftoverPieces: (shown, den) => `${shown}/${den} + ? = 1. What fraction is hiding?`,
    leftoverPiecesHint: "Tap the pieces you can see.",
    tensHint: "Tens you can see. The leftover ones are hiding.",
    ...
    buildHundreds: (target) => `This is ${target}. How many hundreds blocks?`,
    ...
    combineTT: "Two triangles share one side. Count the outside sides. What polygon?",
    combineTQ: "A triangle and a quadrilateral share one side. Count the outside sides. What polygon?",
    combineQQ: "Two quadrilaterals share one side. Count the outside sides. What polygon?",
    combineTP: "A triangle and a pentagon share one side. Count the outside sides. What polygon?",
    ...
    equivN: (num, den, den2) => `${num}/${den} = ?/${den2}. How many?`,
    ...
    squaresHide: (shown) => `${shown} squares showing. Some hide. Area?`,
    ...
    wordTakeHint: "Take the ones you can see. Then name what's hiding.",
