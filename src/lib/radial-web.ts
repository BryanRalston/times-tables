 ...
 * (taller crop, side letterbox gone). Plaza neighbors sit ~39px apart on
 ...
 * CSS `.candy-world` uses 15/16 so the island fills the leftover pink.
 */
export const PHONE_MAP_VIEW = { width: 368, height: (368 * 16) / 15 } as const;
